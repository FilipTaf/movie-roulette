  ...
  return (
    <Container fluid>
      ...
      <Row >
        ...
        <Col xs={3} className={"d-flex justify-content-center"}>2</Col>
        <Col xs={4} className={"d-flex justify-content-center"}>3</Col>
        <Col xs={3} className={"d-flex justify-content-center"}>4</Col>
